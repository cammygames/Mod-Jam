...
public class WarDefence
{
    ...
    public void load(FMLInitializationEvent event)
    {
        ...
        GameRegistry.addRecipe(new ItemStack(Armor.GhillieBoots, 1), new Object[] { "ABA", "A A", 'A', WarDefence.camosegment, 'B', WarDefence.KevlarFiber });
        GameRegistry.addRecipe(new ItemStack(Armor.SpyHat, 1), new Object[] { "AAA", "ABA", 'A', Block.cloth, 'B', WarDefence.KevlarFiber });
        GameRegistry.addRecipe(new ItemStack(Armor.SpyBody, 1), new Object[] { "A A", "ABA", "AAA", 'A', Block.cloth, 'B', WarDefence.KevlarFiber });
        GameRegistry.addRecipe(new ItemStack(Armor.SpyLegs, 1), new Object[] { "AAA", "ABA", "A A", 'A', Block.cloth, 'B', WarDefence.KevlarFiber });
        GameRegistry.addRecipe(new ItemStack(Armor.SpyBoots, 1), new Object[] { "A A", "ABA", 'A', Block.cloth, 'B', WarDefence.KevlarFiber });
        GameRegistry.addRecipe(new ItemStack(Armor.JuggernautHelmet, 1), new Object[] { "AAA", "A A", 'A', WarDefence.KevlarPlate });
